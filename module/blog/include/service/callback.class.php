 ...
 * @author  		Raymond Benc
 * @package  		Module_Blog
 * @version 		$Id: callback.class.php 6598 2013-09-06 08:17:19Z Miguel_Espinoza $
 */
class Blog_Service_Callback extends Phpfox_Service 
{
	...
	public function getActivityFeed($aRow, $aCallback = null, $bIsChildItem = false)
	{
		...
		$aRow = $this->database()->select('b.blog_id, b.title, b.time_stamp, b.total_comment, b.total_like, bt.text_parsed AS text, b.module_id, b.blog_id AS item_id')
