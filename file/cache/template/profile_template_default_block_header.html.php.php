 ...
 * @version 		$Id: header.html.php 6824 2013-10-22 18:04:14Z Fern $
 */
...
<?php Phpfox::getBlock('follow.follow', array()); ?>
...
<?php if (Phpfox ::getService('profile')->timeline() && ( isset ( $this->_aVars['aUser']['page_id'] ) || Phpfox ::getService('user.privacy')->hasAccess('' . $this->_aVars['aUser']['user_id'] . '' , 'profile.view_profile' ) )): ?>
