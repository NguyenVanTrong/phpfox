	...
	<body>
		<div id="container">				
			<div id="main">
				<div class="left">
					<div class="logo">
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'layout/phpfox-logo-dark.png','alt' => '')); ?>
					</div>				
					<ul class="step">
...
<?php $this->getLayout($this->_aVars['sTemplate']); ?>
			...
			<div id="copyright">
<?php echo Phpfox::getLib('phpfox.image.helper')->display(array('theme' => 'layout/phpfox-emblem.png','style' => 'vertical-align:middle;')); ?> <?php echo ' &middot; ' . PhpFox::link(); ?>
			</div>
		</div>
		<script type="text/javascript">
			$Core.init();
