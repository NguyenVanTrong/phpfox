...
<?php /* Cached: May 28, 2014, 4:11 pm */ ?>
<?php 
/**
 * [PHPFOX_HEADER]
 * 
...
<?php if (!$this->bIsSample): ?><div id="site_content"><?php if (isset($this->_aVars['bSearchFailed'])): ?><div class="message">Unable to find anything with your search criteria.</div><?php else:  $sController = "admincp.block/index";  if ( Phpfox::getLib("template")->shouldLoadDelayed("admincp.block/index") == true ): ?>
<div id="delayed_block_image" style="text-align:center; padding-top:20px;"><img src="http://localhost/phpfox/theme/frontend/default/style/default/image/ajax/add.gif" alt="" /></div>
