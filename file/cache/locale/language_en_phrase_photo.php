...
If you enable this setting the original file (that the user uploaded) will be deleted after the thumbnails have been created.

This setting only has an effect if no CDN service is enabled</info>',
